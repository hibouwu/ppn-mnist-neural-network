...
\begin{itemize}
    ...
    \item Architecture et implémentation (7 min)
    \item Résultats expérimentaux (7 min)
...
\begin{itemize}
    ...
    \item Grands (128+) : Généralisent mal
\end{itemize}
...
\textbf{Analyse}
\begin{itemize}
    \item ReLU : Pas de saturation
    \item Sigmoid/Tanh : Trainent
\end{itemize}

\vspace{0.3cm}
\textbf{Conclusion}
\begin{itemize}
    \item ReLU est supérieur grâce à sa sparsité et un gradient non saturant.
\end{itemize}
\end{columns}
\end{frame}
