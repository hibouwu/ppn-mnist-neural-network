    ...
    if (enabled_) {
        ...
        if (metrics_file_.is_open()) {
            metrics_file_
                ...
                << "sync_encode_time_s,sync_comm_time_s,sync_decode_time_s,"
...
void RunArtifactsWriter::appendMetricsRow(int epoch,
    ...
    metrics_file_ << epoch << ","
                  ...
                  << train_metrics.profile.sync_encode_time_s << ","
                  << train_metrics.profile.sync_comm_time_s << ","
                  << train_metrics.profile.sync_decode_time_s << ","
