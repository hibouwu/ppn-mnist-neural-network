...
os.makedirs('output/GEMM', exist_ok=True)

# Path to data
csv_file = 'output/GEMM/thread_scaling.csv'
...
def plot_time_scaling():
    ...
    plt.tight_layout()
    output_path = 'output/GEMM/scaling_plot_advanced.png'
...
def plot_hardware_metrics():
    ...
    for metric, label in metrics.items():
        ...
        plt.tight_layout()
        output_path = f'output/GEMM/hw_metric_{metric.lower()}.png'
        plt.savefig(output_path)
...
def plot_context_switches():
    ...
    output_path = 'output/GEMM/context_switches_vs_threads.png'
...
def plot_cpu_migrations():
    ...
    output_path = 'output/GEMM/cpu_migrations_vs_threads.png'
    plt.savefig(output_path, dpi=150, bbox_inches='tight')
    print(f"Saved {output_path}")
    plt.close()
...
def plot_cache_misses_with_variance():
    ...
    output_path = 'output/GEMM/cache_misses_vs_threads.png'
    plt.savefig(output_path, dpi=150, bbox_inches='tight')
    print(f"Saved {output_path}")
    plt.close()
...
def plot_cache_cv():
    ...
    output_path = 'output/GEMM/cache_cv_vs_threads.png'
    plt.savefig(output_path, dpi=150, bbox_inches='tight')
    print(f"Saved {output_path}")
    plt.close()
