...
**图表**：上下文切换（`:u` 用户态）`output/GEMM/BLAS1/hw_metric_cs.png`（已删除）
...
**图表**：L3 misses 系统级（已放弃）`output/GEMM/BLAS1/hw_metric_l3_misses_syswide.png`（已删除）
...
**图表**：进程级 cache misses `output/GEMM/BLAS1/cache_misses_vs_threads.png`

![Cache Misses 进程级测量](../../output/GEMM/BLAS1/cache_misses_vs_threads.png)
...
**图表**：cache misses 变异系数 `output/GEMM/BLAS1/cache_cv_vs_threads.png`

![Cache Misses 变异系数](../../output/GEMM/BLAS1/cache_cv_vs_threads.png)
...
**图表**：执行时间和 IPC 扩展性 `output/GEMM/BLAS1/scaling_plot_advanced.png`

![执行时间和 IPC 扩展性](../../output/GEMM/BLAS1/scaling_plot_advanced.png)
...
**图表**：Context Switches vs 线程数 `output/GEMM/BLAS1/context_switches_vs_threads.png`
![Context Switches vs 线程数](../../output/GEMM/BLAS1/context_switches_vs_threads.png)
...
**图表**：CPU Migrations vs 线程数 `output/GEMM/BLAS1/cpu_migrations_vs_threads.png`
![CPU Migrations vs 线程数](../../output/GEMM/BLAS1/cpu_migrations_vs_threads.png)
...
**图表**：指令数统计 `output/GEMM/BLAS1/hw_metric_instructions.png`

![指令数统计](../../output/GEMM/BLAS1/hw_metric_instructions.png)
...
**图表**：CPU 周期数 `output/GEMM/BLAS1/hw_metric_cycles.png`

![CPU 周期数](../../output/GEMM/BLAS1/hw_metric_cycles.png)
...
**图表**：每周期指令数 (IPC) `output/GEMM/BLAS1/hw_metric_ipc.png`

![每周期指令数 (IPC)](../../output/GEMM/BLAS1/hw_metric_ipc.png)
...
**图表**：最新的设定下的性能对比（按矩阵尺寸）`output/GEMM/BLAS2/scaling_plot_advanced.png`

![性能对比（按矩阵尺寸）](../../output/GEMM/BLAS2/scaling_plot_advanced.png)
...
- `output/GEMM/hw_metric_ipc.png`：每周期指令数 (IPC)
- `output/GEMM/hw_metric_instructions.png`：总指令数
- `output/GEMM/hw_metric_cycles.png`：CPU 周期数
- `output/GEMM/context_switches_vs_threads.png`：上下文切换（2×2）
- `output/GEMM/cache_misses_vs_threads.png`：缓存未命中（2×2，含方差）
- `output/GEMM/cache_cv_vs_threads.png`：缓存未命中变异系数（2×2）
- `output/GEMM/cpu_migrations_vs_threads.png`：CPU 迁移（2×2）
