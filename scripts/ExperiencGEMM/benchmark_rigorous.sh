...
echo "Implementation,Threads,Size,Reps,Mean,StdDev" > output/rigorous_comparison.csv
...
for size in "${sizes[@]}"; do
    ...
    for config in "${configs[@]}"; do
        ...
        echo "$impl,$threads,$size,$actual_reps,$mean,$std" >> output/rigorous_comparison.csv
    done
done

echo "Rigorous Benchmark completed. Results saved to output/rigorous_comparison.csv"
cat output/rigorous_comparison.csv
