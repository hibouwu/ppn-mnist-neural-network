...
DEFAULT_CONFIG = SCRIPT_DIR / "config" / "avx512_stage2_blocked_candidates.json"
DEFAULT_OUTPUT = (
    REPO_ROOT
    / "output"
    / "ExperienceGEMM"
    / "GotoBLASBlockedAVX512"
    / "stage2_blocked_candidates"
    / "raw"
    / "avx512_stage2_blocked_candidates_raw.csv"
)


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run AVX-512 stage-2 blocked-size candidate sweep.")
