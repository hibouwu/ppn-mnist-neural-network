...
echo "Implementation,Threads,Affinity,Mean,StdDev" > output/ExperienceGEMM/affinity_comparison.csv
...
for impl in "${implementations[@]}"; do
    for t in "${thread_counts[@]}"; do
        for aff in "${affinity_modes[@]}"; do
            ...
            echo "$impl,$t,$aff,$mean,$std" >> output/ExperienceGEMM/affinity_comparison.csv
        done
    done
done

echo "Affinity Benchmark Completed. Results in output/ExperienceGEMM/affinity_comparison.csv"
