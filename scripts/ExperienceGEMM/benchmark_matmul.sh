...
echo "=== Starting Benchmark ===" > output/ExperienceGEMM/benchmark_results.txt
echo "Date: $(date)" >> output/ExperienceGEMM/benchmark_results.txt
echo "----------------------------------------" >> output/ExperienceGEMM/benchmark_results.txt
...
for impl in "${impls[@]}"; do
    ...
    echo "Implementation: $impl" >> output/ExperienceGEMM/benchmark_results.txt
    echo "Total Duration: $duration seconds" >> output/ExperienceGEMM/benchmark_results.txt
    echo "Final Accuracy: $acc" >> output/ExperienceGEMM/benchmark_results.txt
    echo "----------------------------------------" >> output/ExperienceGEMM/benchmark_results.txt
    
    echo "  -> Done in $duration seconds (Acc: $acc)"
done

echo "Benchmark completed. Results saved to output/ExperienceGEMM/benchmark_results.txt"
cat output/ExperienceGEMM/benchmark_results.txt
